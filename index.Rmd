...
- Text files should end with a newline character (i.e., a blank line)
  - If you see the following red icon at the end of a file on GitHub, simply press <kbd>Enter</kbd>/<kbd>Return</kbd> at the end of the file, resave, commit, and the red icon should be gone  
    ```{r}

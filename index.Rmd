...
- Use `.feather` files for outputs from the cohortextractor
...
- [Installed package list](https://github.com/opensafely-core/r-docker/blob/master/packages.csv)
- To request a new package, [open an issue](https://github.com/opensafely-core/r-docker/issues)

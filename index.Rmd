...
- Text files should end with a newline character (i.e., a blank line)
  - If you see the following red icon at the end of a file on GitHub, simply press <kbd>`r knitr::asis_output('\U21B5')` Enter</kbd> at the end of the file (i.e., in this case after the *g*), resave, commit, and the red icon should be gone  
    ```{r}
